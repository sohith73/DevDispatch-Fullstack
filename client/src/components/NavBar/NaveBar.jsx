               ...
               <nav className="bg-[#f7dfc0] p-4 border  border-y-[#e07f00] px-[40px]">
                    <div className="container mx-auto flex justify-between items-center">
                         ...
                         <div className="hidden lg:flex lg:items-center lg:space-x-4 ">
                              ...
                              <Link to='/signup'><button className="bg-[#ffa45d] text-[#5d5e59] font-mono font-semibold rounded-full px-4 py-2 border border-black hover:bg-[#fd9c52]">Sign Up</button></Link>
                         </div>
                    </div>
